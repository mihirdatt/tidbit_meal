...
<head>
    ...
    <title>Food Providers Panel</title>
    <!-- Bootstrap Core CSS -->
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												...
												$sql="SELECT customer_tbl.*, users_orders.* FROM customer_tbl INNER JOIN users_orders ON customer_tbl.u_id=users_orders.u_id where fp_id = '$fpid';";
																			...
																			?>
																						<?php																									
																							...
																							?>
																								...
																								<?php
																								echo '<a href="update_order.php?user_upd='.$rows['o_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';
