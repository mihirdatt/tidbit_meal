        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">MANAGE FOODPROVIDERS</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Food Providers data</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql_0="SELECT * FROM foodprovider_tbl order by fp_id desc";
												$query=mysqli_query($db,$sql_0);
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr>
																								...
																								<center><img src="/tidbit/fp_img/'.$rows['image'].'" class="img-responsive radius"  style="min-width:150px;min-height:100px;"/></center>
																								</div></td>
																								
																								<td>'.$rows['date'].'</td>
																									 <td><a href="delete_foodprovider.php?fp_del='.$rows['fp_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									</td></tr>';
																		}	
														}
