...
<body>
						...
						if(empty($_SESSION["user_id"]))
							{
                                ...
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
                                     ...
                                     <a class="dropdown-item" href="login_fp.php">Login As FoodProvider</a>
                                </div>
                                </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?fp_id=<?php echo $_GET['fp_id']; ?>">Pick your favorite tiffin</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from foodprovider_tbl where fp_id='$_GET[fp_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/dish2.jpeg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="fp_img/'.$rows['image'].'" alt="Restaurant logo">'; ?></figure>
                                </div>
                            </div>
							
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    <h6><a href="#"><?php echo $rows['t_name']; ?></a></h6>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="dishes.php?fp_id=<?php echo $_GET['fp_id']; ?>&action=remove&id=<?php echo $item["fi_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
						...
						<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from fooditem_tbl where fp_id='$_GET[fp_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='dishes.php?fp_id=<?php echo $_GET['fp_id'];?>&action=add&id=<?php echo $product['fi_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="Foodprovider_panel/Fooditems_img/'.$product['image'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
