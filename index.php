...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/main2.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & Take-Out </h1>
                    <h5 class="font-white space-xs">Find food providers, special tiffins, and reviews for free</h5>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose FoodProvider</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Tiffin</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
						...
						$query_res= mysqli_query($db,"select * from fooditem_tbl LIMIT 3"); 
									      while($r=mysqli_fetch_array($query_res))
										  {
													
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="Foodprovider_panel/FoodItems_img/'.$r['image'].'">
															
															</div>
															<div class="content">
																<h5><a href="dishes.php?res_id='.$r['fi_id'].'">'.$r['title'].'</a></h5>
																<div class="product-name">'.$r['about'].'</div>
																<div class="price-btn-block"> <span class="price">Rs.'.$r['price'].'</span> <a href="dishes.php?fp_id='.$r['fp_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>The Best Tiffin Service</h3>
                                <p>Now you can make food happen pretty much wherever you are thanks to the free easy-to-use Tiffin Delivery &amp; Takeout Web.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-widget section-padding">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/FOOTER LOGO.png" alt="Footer logo"> </a> </div>
