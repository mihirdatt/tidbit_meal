...
{        
     if(empty($_POST['username']) ||
      ...
      empty($_POST['address']))
	    ...
	    {
         $sql_0= "SELECT username, email FROM foodprovider_tbl where username ='".$_POST['username']."'
         ...
         if($num==1)
         {
            $message2 = "Entry already exists !!";
                ...
                {        
                    ...
                    {
                          $sql_1 = "INSERT INTO foodprovider_tbl(ar_id,username,t_name,email, phone, password, 
                                address,image) VALUES ('".$_POST['a_name']."','".$_POST['username']."','".$_POST['t_name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['password']."',
                                '".$_POST['address']."','".$fnew."');";
                        ...
                        $success = "Account Created successfully! <p>You will be redirected in <span id='counter'>5</span> second(s).</p>
														...
														function countdown() {
															...
															if (parseInt(i.innerHTML)<=0) {
																location.href = 'foodprovider_panel';
															}
															i.innerHTML = parseInt(i.innerHTML)-1;
														}
														setInterval(function(){ countdown(); },1000);
														</script>'";
		                                    header("refresh:5;url=foodprovider_panel");
                    }
                }
                elseif($extension == '')
					{
						$error = 	'<div class="alert alert-danger alert-dismissible fade show">
											...
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>invalid extension!</strong>png, jpg are accepted.
															</div>';
						} 
        }
	}
...
<head>
    ...
    <link rel="icon" href="#">
    <title>Foodprovider Registration</title>
    <!-- Bootstrap core CSS -->
                     ...
                     <div class="col-md-8">
                        <div class="widget">
                           <div class="widget-body">
							  ...
							  <form onSubmit="return validate()" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-12">
                                       ...
                                       <input class="form-control" type="text" name="t_name" id="example-text-input" placeholder="Title Name"> 
                                    </div>
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <select name="a_name" class="form-control custom-select" data-placeholder="Choose Area" tabindex="1" >
